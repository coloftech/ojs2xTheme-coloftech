 ...
 <nav id="mainmenu" class="navbar navbar-default" role="navigation">
  ...
  <div class="collapse navbar-collapse navbar-ex1-collapse">
    <ul class="nav navbar-nav">
	  <li id="homeMenu" {if $requestedPage == 'index'}class="active"{/if}><a href="{url page="index"}">{translate key="navigation.home"}</a></li>
	  <li id="aboutMenu" {if $requestedPage == 'about'}class="active"{/if}><a href="{url page="about"}">{translate key="navigation.about"}</a></li>
	  <li id="aboutSubmissionsMenu" {if $requestedPage == 'about' && $requestedOp == 'submissions'}class="active"{/if}><a href="{url page="login" op=""}">{translate key="navigation.submissions"}</a></li>
	</ul>
