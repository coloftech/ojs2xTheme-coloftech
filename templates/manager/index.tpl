...
<ul class="nav nav-tabs nav-tabs-info">
  <li class="active"><a data-toggle="tab" href="#managementPages">{translate key="manager.managementPages"}</a></li>
  <li><a data-toggle="tab" href="#managerUsers">{translate key="manager.users"}</a></li>
  <li><a data-toggle="tab" href="#managerRoles">{translate key="manager.roles"}</a></li>
</ul>

<div class="tab-content">
    <div id="managementPages"  class="tab-pane fade in active">
        ...
        <div id="managerUsers"  class="tab-pane fade">
    ...
    <div id="managerRoles"  class="tab-pane fade">
